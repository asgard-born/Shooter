...
public class ETCJoystick : ETCBase,IPointerEnterHandler, IDragHandler, IBeginDragHandler, IPointerDownHandler, IPointerUpHandler {
	...
	public event Action OnTouchStartAction;
	public event Action OnTouchUpAction;
    ...
    public float GetAxisX() {
        if (axisX.axisValue != 0)
			return axisX.axisValue;

        return 0;
    }

    public float GetAxisY() {
        if (axisY.axisValue != 0)
			return axisY.axisValue;
